...
/**
 * Servlet implementation class searchReviews
 */
...
public class searchReviews extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("-- Running search.java GET --");
		...
		try {
			...
			// Sending rewiew summary to front end
			...
			request.getRequestDispatcher("FindReviews.jsp").forward(request, response);
